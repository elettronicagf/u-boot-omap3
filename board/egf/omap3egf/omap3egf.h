 ...
 * MA 02111-1307 USA
 */
#ifndef _OMAP3_EGF_H_
#define _OMAP3_EGF_H_

const omap3_sysinfo sysinfo = {
	DDR_STACKED,
	"ElettronicaGF SOM 336",
...
/*SDRC*/\
 ...
 MUX_VAL(CP(UART1_RTS),		(IDIS | PTD | DIS | M4)) /*UART1_RS485-DIR GPIO_149*/ \
 MUX_VAL(CP(UART1_CTS),		(IDIS | PTD | DIS | M4)) /*UART1_RS485-nRE GPIO_150*/ \
 ...
 /*Serial Interface*/\
 MUX_VAL(CP(UART3_CTS_RCTX),	(IDIS  | PTU | EN  | M4)) /*GPIO163 MEMS_INT2 */\
 MUX_VAL(CP(UART3_RTS_SD),	(IDIS  | PTU | EN  | M4)) /*GPIO164 MEMS_INT1 */\
