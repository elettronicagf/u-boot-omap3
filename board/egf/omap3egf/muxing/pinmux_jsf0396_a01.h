...
#define MUX_JSF0396_A01() \
 ...
 MUX_VAL(CP(HDQ_SIO),		(IEN  | PTU | EN  | M4)) /*WLAN-IRQ*/\
 ...
 MUX_VAL(CP(MCBSP1_CLKR),	(IEN  | PTU | DIS | M0)) /*MCBSP1_CLKR*/\
 MUX_VAL(CP(MCBSP1_DR),		(IEN  | PTU | DIS | M0)) /*MCBSP1_DR*/\
 MUX_VAL(CP(MCBSP1_DX),		(IDIS | PTU | DIS | M0)) /*MCBSP1_DX*/\
