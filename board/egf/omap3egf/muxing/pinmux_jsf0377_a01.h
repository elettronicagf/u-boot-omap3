...
#define MUX_JSF0377_A01() \
 ...
 MUX_VAL(CP(GPMC_NBE1),		(IDIS | PTD | DIS | M4)) /*GPIO 61*/\
 MUX_VAL(CP(GPMC_WAIT2),	(IDIS | PTD | DIS | M2)) /*UART4_TX (available for 37xx only)*/\
 MUX_VAL(CP(GPMC_WAIT3),	(IEN  | PTD | DIS | M2)) /*UART4_RX (available for 37xx only)*/\
 ...
 MUX_VAL(CP(DSS_DATA0),		(IDIS | PTD | DIS | M4)) /*GPIO 70*/\
 ...
 MUX_VAL(CP(DSS_DATA8),		(IDIS | PTD | DIS | M4)) /*GPIO 78*/\
 MUX_VAL(CP(DSS_DATA9),		(IDIS | PTD | DIS | M4)) /*GPIO 79*/\
 ...
 MUX_VAL(CP(DSS_DATA16),	(IDIS | PTD | DIS | M7)) /*NC*/\
 ...
 MUX_VAL(CP(MCBSP3_CLKX),	(IDIS | PTU | EN | M4)) /*GPIO_142  TCK */\
 MUX_VAL(CP(MCBSP3_FSX),	(IEN  | PTU | EN | M4)) /*GPIO_143  TDO */\
 /*Uart 2*/\
 MUX_VAL(CP(UART2_TX),		(IDIS| PTD | DIS| M0)) /*UART2_TX */\
 MUX_VAL(CP(UART2_RTS),		(IDIS| PTD | DIS| M7)) /*Unconnected*/\
 MUX_VAL(CP(UART2_CTS),		(IEN | PTU | EN| M4))  /*GPIO_144 - GPS_TX READY*/\
 ...
 MUX_VAL(CP(MCBSP1_CLKR),	(IEN   | PTU | EN | M4)) /*GPIO156 GYRO-INT2 */\
 MUX_VAL(CP(MCBSP1_FSR),	(IEN   | PTU | EN | M4)) /*GPIO157 ECOMPASS-INT2*/\
 MUX_VAL(CP(MCBSP1_CLKX),	(IEN   | PTU | EN | M4)) /*GPIO162 GYRO-INT1*/\
 MUX_VAL(CP(MCBSP1_DX),		(IDIS  | PTU | EN | M4)) /*GPIO158 GYRO-nRESET*/\
 MUX_VAL(CP(MCBSP1_DR),		(IEN   | PTU | EN | M4)) /*GPIO159 ECOMPASS-nRESET*/\
 MUX_VAL(CP(MCBSP1_FSX),	(IEN   | PTU | EN | M4)) /*GPIO161 ECOMPASS-INT1*/\
 ...
 MUX_VAL(CP(MCSPI1_CS2),	(IDIS | PTD | EN  | M0)) /*McSPI1_CS2*/\
 /* USB EHCI (port 2) */\
